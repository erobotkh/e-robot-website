  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <div class="d-flex align-items-center justify-content-between">
          <a href="{{ url('admin') }}" class="logo d-flex align-items-center">
              <img style="width: 65px height: 65px" src="{{ URL::asset('assets/img/erobot-no-bg.png') }} " alt="">
              <span class=" d-none d-lg-block">E-Robot</span>
          </a>
        ...
        --}}
              ...
              <li class="nav-item dropdown pe-3">
                  ...
                  <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                      ...
                      <img src="{{url('images/photo_members/sticker-e-robot.png')}}" alt="Profile" class="rounded-circle">
