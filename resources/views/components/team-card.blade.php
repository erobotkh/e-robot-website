...
<div class="w-full rounded-xl shadow-lg hover:shadow-xl border">
    <a class="text-decoration-none w-full">
        ...
        <div class="w-full relative">
            ...
            <div class="text-gray-600  pl-[35%] font-semibold text-[20px]">
                {{$teamLeader}}
                <div class="position  text-[12px] text-[#dc2626af]">Leader</div>

            </div>
        </div>
        <div class="px-8 mt-[30px] pb-1 font-bold text-xl text-[#DC2626]"><h2>{{$department}}</h2></div>
        <article class="px-8 text-justify line-clamp-4">{{$description}}</article>
    </a>
</div>