<footer class="border-t-2 border-red-600">
    <div class="container px-1 pt-5 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-3">
            <div class="grid-1 sm:col-span-2 lg:col-span-1 flex flex-col lg:flex-row   ">
                ...
                <div>
                    <p class="text-center lg:text-left text-[14px] font-semibold uppercase">A team that comes with a pure heart of cambodia youths</p>
                    <div class="flex justify-center lg:justify-start gap-4 mt-2">
                        ...
                        <a href="https://www.tiktok.com/@e_robot_cambodia" target="_blank">
                            <button class="bg-black w-7 h-7 p-1 font-semibold text-white inline-flex items-center space-x-2 rounded-full hover:border border-black">
