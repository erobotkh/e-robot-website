...
<div class="headerTop w-full  bg-red-600 flex items-center justify-between lg:px-5 md:px-2 lg:py-1 md:py-1 sm:py-3 ">
    <div class="headerTop_left px-3 md:p-0">
        <div class="lg:flex md:flex items-center font-bold text-[#FFE17B] sm:flex-cols ">

            <div class="title text-sm  pr-1 lg:block md:block hidden ">
                <div class="flex items-center gap-1">
                    <i class='bx bx-time-five font-bold'></i>OPERATION HOURS:
                </div>
            </div>
            <div class="title text-[15px]  pr-1 block lg:hidden md:hidden">
                <div class="flex items-center gap-1">
                    <i class='bx bx-time-five font-bold'></i>8:00-17:00
                    (Daily)
                </div>
            </div>
    ...
    <div
        ...
        <select class="vodiapicker">
            <option value="en" class="test"
                data-thumbnail="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Flag_of_the_United_Kingdom_%281-2%29.svg/1200px-Flag_of_the_United_Kingdom_%281-2%29.svg.png">
            </option>
...
<!-- header content -->
<!-- component -->
<nav class=" z-10  relative sticky top-0 w-full" x-data="{open:false,menu:false, lokasi:false}">
    <div class="relative bg-white px-5" style="box-shadow: rgba(33, 35, 38, 0.1) 0px 10px 10px -10px; ">
        ...
        <div class="max-w-[1600px] mx-auto">
            <div class="relative flex items-center justify-end h-20">
                <div class="flex items-center justify-end  ">
                    ...
                    <div class="hidden lg:block">
                        <div class="flex">
                            <a href="/home"
                                class="menu border-[3px] border-white  uppercase ml-4 px-3 py-2   leading-5 text-red-600 font-bold  transition duration-150 ease-in-out cursor-pointer focus:outline-none "
                                style="font-family: 'Battambang', cursive;"> Home </a>
                            <a href="/resource"
                                class="menu border-[3px] border-white  uppercase ml-4 px-3 py-2   leading-5 text-red-600 font-bold  transition duration-150 ease-in-out cursor-pointer focus:outline-none "
                                style="font-family: 'Battambang', cursive;"> Resources </a>
                            <a href="/list_content"
                                class="menu border-[3px] border-white  uppercase ml-4 px-3 py-2   leading-5 text-red-600 font-bold  transition duration-150 ease-in-out cursor-pointer focus:outline-none "
                                style="font-family: 'Battambang', cursive;"> Activity </a>

                            <div
                                class="group relative ml-4 border-[3px] border-white rounded-md  leading-5 text-red-600 font-bold transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:bg-blue-500 ">
                                <button class="outline-none focus:outline-none px-3 rounded-sm flex items-center">
                                    <span class="font-bold flex-1 pr-1 px-3 py-2 uppercase"
                                        style="font-family: 'Battambang', cursive;">About</span>
                                    <span>
                            ...
                            transition duration-150 ease-in-out" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <ul class="bg-white rounded-sm transform scale-0 group-hover:scale-100 absolute
            ...
            <form methode="get" action="#" class="relative z-50">
              ...
              <input type="text" name="s" id="s" class="block w-full pl-10 pr-3 py-2   rounded-md leading-5  text-gray-300 placeholder-gray-400 focus:outline-none focus:bg-white focus sm: transition duration-150 ease-in-out border" placeholder="Search">
                    ...
                    <button
                        class="bg-red-600 font-bold hidden lg:inline-block rounded-lg hover:bg-red-500 hover:scale-[0.98] hover:rounded-lg hover:transition-[1s] transition-[1s]"
                        style="box-shadow: rgba(0, 0, 0, 0.09) 0px 3px 12px;"> <a
                            href="{{ route('donation_view') }}"
                            class="hover:text-white text-white px-6 py-4 flex items-center flex-col rounded-lg"
                            style="font-family: 'Battambang', cursive; box-shadow: rgba(0, 0, 0, 0.09) 0px 3px 12px;">Donate</a></button>
              ...
              <span  style="font-family: 'Battambang', cursive;">Account</span>
                ...
                <div class="flex lg:hidden">
                    <button @click="menu=!menu"
                        class="inline-flex items-center justify-center p-2 rounded-md focus:outline-none focus:bg-black transition duration-150 ease-in-out"
        ...
        <div x-show="menu" class="block lg:hidden">
            <ul class="px-2 pt-2 pb-3">
                <li>
                    <a href="/home"
                        class="mt-1 block px-3 py-2 rounded-md text-red-600 font-semibold hover:bg-black f hover:text-white focus:outline-none focus:bg-black transition duration-150 ease-in-out"
                        style="font-family: 'Battambang', cursive;">Home </a>
                </li>
                <li>
                    <a href="/list_content"
                ...
                <li>
                    <a href="/resource"
                        class="mt-1 block px-3 py-2 rounded-md text-red-600  font-semibold hover:bg-black f hover:text-white focus:outline-none focus:bg-black transition duration-150 ease-in-out"
                        style="font-family: 'Battambang', cursive;">Resource </a>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full font-bold py-2 pr-2 text-base text-red-600 hover:text-white transition duration-75 rounded-lg group hover:bg-black"
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2 text-semibold text-red-600 ">
                        ...
                        <li>
                            <a href="/about/team-leader"
                                class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg hover:text-white group hover:bg-black pl-11">Team</a>
                        </li>
                        <!-- <li>
							<a href="/about/team-member"
								class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg hover:text-white group hover:bg-black pl-11">Team Member</a>
						</li> -->
                        <li>
                ...
                <li>
                    <a href="{{ route('donation_view') }}"
                        class="mt-1 block px-3 py-2 rounded-md text-red-600 font-semibold hover:bg-black f hover:text-white focus:outline-none focus:bg-black transition duration-150 ease-in-out"
                        style="font-family: 'Battambang', cursive;">Donte</a>
                </li>
            </ul>
        </div>
    </div>
