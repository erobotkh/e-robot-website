...
<div class="my-4">
      <div
        class="p-8 py-5 w-[350px] md:w-[500px] border border-red-200 rounded-lg mx-auto mt-5 shadow-md shadow-slate-800"
      >
        ...
        <div class="flex gap-2">
          ...
          >
            ...
            <h1
              class="py-3 w-5/6 text-center text-gray-600 font-bold hidden md:block"
            >
              Github
            </h1>
          </a>
          ...
          >
            ...
            <h1
              class="px-3 py-3 w-5/6 text-center text-gray-600 font-bold hidden md:block"
            >
              Facebook
            </h1>
          </a>
